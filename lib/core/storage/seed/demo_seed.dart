...
Future<void> _seedMedications(AppDatabase db, DateTime today) async {
  final meds = [
    MedicationsCompanion(
      ...
      scheduleGroup: const Value(MedScheduleGroup.withFood),
      timingCuesJson: const Value('["withFood"]'),
    ...
    MedicationsCompanion(
      ...
      doctor: const Value('Dr. Menon'),
      scheduleGroup: const Value(MedScheduleGroup.byClock),
      timingCuesJson: const Value('["morning"]'),
    ...
    MedicationsCompanion(
      ...
      scheduleGroup: const Value(MedScheduleGroup.byClock),
      timingCuesJson: const Value('["night"]'),
    ...
    MedicationsCompanion(
      ...
      doctor: const Value('Dr. Menon'),
      scheduleGroup: const Value(MedScheduleGroup.weekly),
      timingCuesJson: const Value('["dialysisDayOnly"]'),
    ...
    MedicationsCompanion(
      ...
      doctor: const Value('Dr. Menon'),
      scheduleGroup: const Value(MedScheduleGroup.byClock),
      timingCuesJson: const Value('["beforeFood","morning"]'),
